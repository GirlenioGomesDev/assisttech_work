...
export function MainLayout() {
  ...
  <div className="px-6 py-4 border-b border-gray-200"><p className="text-sm text-gray-900">{user?.nome}</p><p className="text-xs text-gray-500 capitalize">{perfilLabel}</p></div>
